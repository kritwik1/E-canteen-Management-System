...
<table class="table" border="1">
  <tr>
    <td class="table-danger">PID</td>
    <td class="table-danger">Product Name</td>

    <td class="table-danger">Product Price</td>
    <td class="table-danger">Availability</td>
  </tr>
</div>
...
$sql = "SELECT * FROM products where ptype='snacks'";
