...
<table class="table" border="1">
  <tr>
    <td class="table-info">PID</td>
    <td class="table-info">Product Name</td>

    <td class="table-info">Product Price</td>
    <td class="table-info">Availability</td>
  </tr>
</div>
...
$sql = "SELECT * FROM products where ptype='breakfast'";
